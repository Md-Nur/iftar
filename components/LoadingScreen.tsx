...
export default function LoadingScreen({ onDone }: { onDone: () => void }) {
    ...
    return (
        ...
        >
            ...
            >
                <div className="rounded-full overflow-hidden w-28 h-28 bg-base-100">
                    <Image src="/logo.jpg" alt="লোগো" width={112} height={112} className="object-cover" />
                </div>
            </div>

            <h1 className="mt-6 text-2xl font-bold text-primary tracking-wide"
                style={{ textShadow: '0 2px 12px rgba(212,175,55,0.4)' }}>
                রাজশাহী ইফতার ম্যাপ
            </h1>
            <p className="mt-2 text-sm text-neutral-content">লোড হচ্ছে...</p>
        </div>
    )
}
